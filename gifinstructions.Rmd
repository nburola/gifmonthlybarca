...
## Extracting specific elements and then subset/filter for file names 
```{r}
file_list <- list.files("C:/Users/Nathaniel Burola/Documents/Jobs/NOAA and Ocean Associates/Whales-Fisheries Interaction Modeler/gifmonthlybarca/barca_monthly")
file_list
...
## Writing the method and trying it Sam Woodman's method 
```{r}
file.names <- list.files("C:/Users/Nathaniel Burola/Documents/Jobs/NOAA and Ocean Associates/Whales-Fisheries Interaction Modeler/gifmonthlybarca/barca_monthly") 
file.names

file.names.dates <- as.Date(substr(file.names, 13, 22))
